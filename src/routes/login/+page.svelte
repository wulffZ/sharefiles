<script lang="ts">
    ...
    async function login() {
        try {
            ...
            error = err?.response || "An unexpected error occurred. Please check the console and report.";
        }
    }
</script>
...
>
    ...
    <div class="mt-2">
        ...
        <Input id="default-input" type="password" placeholder="Password" bind:value={form.password} name="password"
               class="mt-2"
               required/>
    </div>
